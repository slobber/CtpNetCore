...
namespace PureCode.CtpCSharp
{
    public class TradeApi
    {
        ...
        public TradeApi(string pFile)
        {
            ...
            (loader.Invoke("RegisterSpi", typeof(DeleRegisterSpi)) as DeleRegisterSpi)(_api, _spi);
        }
        ...
        {
            (loader.Invoke("RegisterSpi", typeof(DeleRegisterSpi)) as DeleRegisterSpi)(_api, IntPtr.Zero);
