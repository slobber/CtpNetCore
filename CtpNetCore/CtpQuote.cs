...
using System.Text;
using static PureCode.CtpCSharp.QuoteApi;
...
namespace PureCode.CtpCSharp
{
    public class CtpQuote : Quote
    {
        ...
        void SetCallBack()
        {
            _q.SetOnFrontConnected((OnFrontConnectedAction)AddDele(new OnFrontConnectedAction(CTPOnFrontConnected)));
            _q.SetOnRspUserLogin((OnRspUserLoginAction)AddDele(new OnRspUserLoginAction(CTPOnRspUserLogin)));
            _q.SetOnFrontDisconnected((OnFrontDisconnectedAction)AddDele(new OnFrontDisconnectedAction(CTPOnFrontDisconnected)));
            _q.SetOnRspSubMarketData((OnRspSubMarketDataAction)AddDele(new OnRspSubMarketDataAction(CTPOnRspSubMarketData)));
            _q.SetOnRtnDepthMarketData((OnRtnDepthMarketDataAction)AddDele(new OnRtnDepthMarketDataAction(CTPOnRtnDepthMarketData)));
            _q.SetOnRspError((OnRspErrorAction)AddDele(new OnRspErrorAction(CTPOnRspError)));
        }
        ...
        {
            return (Marshal.PtrToStringAnsi(_q.Version())).ToString();
        }
    }
}
