...
namespace PureCode.CtpCSharp
{
    ...
    public enum TThostFtdcTradeTypeType : byte
    {
        ...
        ///</summary>
        THOST_FTDC_TRDT_SplitCombination = (byte)'#',
        /// <summary>
        /// 普通成交
        ///</summary>
    ...
    /// 交易代码类型
    ///</summary>
    public enum TThostFtdcVirementTradeCodeType : int
    {
        /// <summary>
        /// 银行发起银行资金转期货
        ///</summary>
    ...
    /// 银期交易代码枚举类型
    ///</summary>
    public enum TThostFtdcFBTTradeCodeEnumType : int
    {
        /// <summary>
        /// 银行发起银行转期货
        ///</summary>
    ...
    /// 紧急程度类型
    ///</summary>
    public enum TThostFtdcNewsUrgencyType : int
    {
    }
}
